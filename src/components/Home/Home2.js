...
import myImg from "../../Assets/nav resume pic.jpg";
        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I fell in love with programming especially in building web applications.
              <br />
              ...
              <i>
                <b className="purple"> Responsive Web applications and Products </b> and
